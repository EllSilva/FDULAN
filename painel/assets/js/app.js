...
const routes = [
  ...
  {
    path: "/novo-projecto",
    component: { template: "<p-novo_projecto></p-novo_projecto>" },
  },
  {
    path: "/novo-mapa",
    component: { template: "<p-novo_mapa></p-novo_mapa>" },
  },

  { path: "/blog", component: { template: "<p-blog></p-blog>" } },
  {
    path: "/novo_blog",
    component: { template: "<p-novo_blog></p-novo_blog>" },
  },
  {
    path: '/blog/editar/:id',  name:"editar_blog",  
    component: { template: "<p-edita_blog></p-edita_blog>" },
  },

  { path: "/galeria", component: { template: "<p-galeria></p-galeria>" } },
  {
    path: "/novo_galeria",
    component: { template: "<p-novo_galeria></p-novo_galeria>" },
  },

  { path: "/novo-usuario", component: { template: "<p-usuario></p-usuario>" } },
  {
    path: "/nova-mensagem",
    component: { template: "<p-mensagem></p-mensagem>" },
  },
];
